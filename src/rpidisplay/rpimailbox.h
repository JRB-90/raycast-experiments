#ifndef _RPI_MAILB_H_
#define _RPI_MAILB_H_
...
// Enum of the RPI->Videocore firmware mailbox property interface properties,
...
typedef struct rpi_mailbox_property_t {
    int tag;
    int byte_length;
    union {
        int value_32;
...
typedef enum rpi_tag_clock_id_t {
...
extern void RPI_PropertyInit();
extern void RPI_PropertyAddTag(rpi_mailbox_tag_t tag, ...);
extern int RPI_PropertyProcess();
